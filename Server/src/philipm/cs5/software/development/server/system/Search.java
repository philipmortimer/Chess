...
public class Search {
    ...
    /**
     * Performs a binary search on the array inputted. It searches for the itemToFind.
     * It uses binary search and assumes that the data is lexographically sorted.
     * @param DATA The data to be searched through.
     * @param ITEM_TO_FIND The item to find
     * @return The row number is returned if not, -1 is returned
     */
